...
const ALL: string[] = [];
const NON_ADMIN = ['DEPARTMENT_HEAD', 'PROFESSOR', 'STAFF', 'STUDENT'];
...
const menuConfig: Entry[] = [
  ...
  { kind: 'link', to: '/requests/new', label: 'Nouvelle demande', icon: 'doc', roles: NON_ADMIN },
  { kind: 'link', to: '/requests', label: 'Mes demandes', icon: 'docCheck', roles: NON_ADMIN },
  ...
  { kind: 'section', label: 'Rapports & Paie', roles: HR },
  { kind: 'link', to: '/reports', label: 'Rapports', icon: 'doc', roles: HR },
  { kind: 'link', to: '/salary', label: 'Paie', icon: 'inbox', roles: HR },
  { kind: 'link', to: '/performance', label: 'Evaluations', icon: 'shield', roles: HR },
