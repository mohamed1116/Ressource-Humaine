                ...
                return (
                  <tr key={r.id as string} className="border-b border-gray-50 hover:bg-gray-50/50">
                    ...
                    <td className="px-5 py-3 text-right">
                      {r.type === 'CERTIFICATE' && r.status === 'APPROVED' ? (
                        <button onClick={handleDownload} className="px-3 py-1 text-xs font-medium text-blue-700 border border-blue-200 rounded hover:bg-blue-50">
                          Telecharger PDF
                        </button>
                      ) : (
