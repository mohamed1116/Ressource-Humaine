                ...
                return (
                  <tr key={r.id as string} className="border-b border-gray-50 hover:bg-gray-50/50">
                    ...
                    <td className="px-5 py-3 text-right">
                      {r.type === 'FREE' && r.attachment_url ? (
                        <a
                          href={r.attachment_url as string}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="px-3 py-1 text-xs font-medium text-amber-700 border border-amber-200 rounded hover:bg-amber-50 inline-flex items-center gap-1"
                        >
